...
#define AD_CONST_REDIS_KEY_RD_MAX_VOLUME "rd_max_volume"
#define AD_CONST_REDIS_KEY_RD_CUR_VOLUME "rd_cur_volume"
#define AD_CONST_REDIS_KEY_RD_HEIGHT "rd_height"
